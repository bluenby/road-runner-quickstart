...
public class TrajectorySequenceRunner {
    ...
    public void followTrajectorySequenceAsync(TrajectorySequence trajectorySequence, Telemetry t) {
        currentTrajectorySequence = trajectorySequence;
        currentSegmentStartTime = clock.seconds();
        currentSegmentIndex = 0;
        lastSegmentIndex = -1;
        t.addData("WE MADE IT", "OVER HERE IN TRAJECTORYSEQUENCERUNNER.JAVA");
        t.update();
    }
